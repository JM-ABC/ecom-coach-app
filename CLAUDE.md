...
- **맘큐 사은품 활용 가능** → 자사몰 단독 프로모션에서 사은품 증정 기획 가능. 사은품 가액 기준은 히어로 제품 단가의 10% 수준 (예: 1만원 제품 → 사은품 1천원 상당). AI 기획서·액션플랜에서 사은품 옵션 제안 시 이 기준 적용
- **맘큐 배송 제안 금지** → 배송 운영(맘쑝배송 포함)은 서비스팀 영역. 액션 플랜·체크리스트에서 배송 관련 제안 일체 제외. 참고: 맘큐 배송 서비스명은 맘쑝배송(오늘 주문→내일 도착)
