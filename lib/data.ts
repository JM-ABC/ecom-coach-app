...
export const EVENTS: MarketingEvent[] = [
  ...
  },
  {
    ...
    pro: '맘큐 커뮤니티의 "신생아 용품 추천 후기"는 구매 전환율이 일반 광고의 3배입니다. 신제품 런칭 시 커뮤니티 체험단 20명 확보를 먼저 하고 광고를 집행하세요. 6월은 더위가 시작되며 신생아 체온 관리·여름 위생용품 수요가 급증하는 시기로, 시즌 맞춤 번들 기획이 효과적입니다.',
  },
  {
