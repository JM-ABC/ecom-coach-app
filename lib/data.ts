...
export const EVENTS: MarketingEvent[] = [
  ...
  },
  {
    ...
    summary: '장마철 고온다습 환경에서 면행주 세균 번식이 급증하는 시기. 크리넥스 빨아쓰는 행주·스카트 키친타올 중심의 주방 위생 루틴 전환 수요가 집중됩니다. 맘큐 즉시 실행 가능(외부 플랫폼 신청 불필요).',
    trendScore: 78, search: '+45%', gmv: '+38%',
    products: [
      { name: '크리넥스 빨아쓰는 행주', reason: '장마철 면행주 세균 번식 교체 수요 최고점, 시즌 히어로 제품', urgency: 'high', category: 'l_clean', priceRange: { min: 8000, max: 18000 }, prepDays: 10, momqTip: '맘큐 단독 20% 할인 + 스카트 키친타올 번들 구성. 강수확률 60%↑ 예보일 앱 푸시 타이밍 연동.' },
      { name: '스카트 키친타올', reason: '1회 사용 위생, 빠른 건조. 행주 번들 구성 최적 파트너', urgency: 'high', category: 'l_clean', priceRange: { min: 6000, max: 15000 }, prepDays: 7, momqTip: '행주+키친타올 "장마 주방 위생 세트" 번들. 3만원 이상 구매 시 항균 물티슈 증정(히어로 단가의 10% 수준 사은품).' },
    ...
    checklist: [
      ...
      { d: -7, task: '크리넥스 행주·스카트 키친타올 재고 2주치 확보', done: false },
    ...
    platformTips: {
      ...
      naver: { tip: '"빨아쓰는 행주", "장마 주방청소", "항균 행주" 쇼핑검색 입찰 추가. 기획전 신청 마감 오늘(6/5).', action: '장마 주방청소 키워드 광고 입찰 상향', metric: '검색 클릭 +40%' },
